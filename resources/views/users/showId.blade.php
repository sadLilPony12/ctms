<?php  
    ...
    $urlName = substr($url, strpos($url, "/admin/") + 7);    
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">                                    
                                    <div class="breadcomb-icon">
                                        <?php if($urlName == "br"){ ?>
                                            <button data-toggle="modal" id="btn-Download-br" data-toggle="tooltip" data-placement="left" style="border:none; background-color:transparent;" title="Download card"><i class="notika-icon notika-form"></i></button>
                                        <?php }else{ ?>
                                            <button data-toggle="modal" id="btn-Download-qr" data-toggle="tooltip" data-placement="left" style="border:none; background-color:transparent;" title="Download card"><i class="notika-icon notika-form"></i></button>
                                        <?php } ?>
                                    </div>
                                    <div class="breadcomb-ctn">
                                        <h2><?php echo $codeName; ?></h2>
                                        <p>Download <?php echo $codeName; ?> to add in your ID.</span></p>
                                    </div>
                                </div>
                            </div>
